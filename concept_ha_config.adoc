...
*Clúster ONTAP Select de cuatro nodos que utiliza almacenamiento con conexión local*
image:DDHA_02.jpg["Clúster ONTAP Select de cuatro nodos mediante almacenamiento con conexión local"]
